import WebLogo from "./NavBar/WebLogo";

const Footer = () => {
    return (<>
        <footer className="relative z-10 bg-slate-600 text-white pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
                    ...
                    <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
                        <div className="mb-10 w-full">
                            <a href="/#" className="mb-6 inline-block max-w-[160px]">
                                <WebLogo />
                                <h1 className="p-3 text-2xl">job Hub</h1>
                            </a>
                    ...
                    <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                        <div className="mb-10 w-full">
                            ...
                            <div className="mb-6 flex items-center">
                                <a href="javascript:void(0)" className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:border-primary hover:bg-primary hover:text-white dark:border-dark-3 dark:text-white dark:hover:border-primary sm:mr-4 lg:mr-3 xl:mr-4">
...
const NavLink = ({link, label}) => {
    return (<li>
        <a href={link}
            className="inline-block text-base leading-loose text-body-color hover:text-primary dark:text-dark-6"> {label} </a>
    </li>);
};
